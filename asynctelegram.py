...
last_refresh_time = 0
csv_path = Path(r"C:\Users\evanb\git\AI\NEWFILES\OBEYORDIE\messages1.csv")
...
async def alarm(context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    with csv_path.open('r', encoding='utf-8', errors='ignore') as f:
        ...
        try:
            ...
            # We've reached the end of the CSV file. Refresh it.
            last_refresh_time = 0
            f.seek(0)
            next(reader, None)
            next(reader, None)
            message = next(reader)[0]  # read the first message after refreshing
