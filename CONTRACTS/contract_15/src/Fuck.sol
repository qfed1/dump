// Website: https://fuckcoineth.xyz/
// Twitter: https://twitter.com/fuckcoineth
// A utility token by https://twitter.com/sibeleth for the FTC NFT project (https://twitter.com/nftftc)
...
contract Fuck is Context, IERC20 {
    ...
    function nameFunction() public pure returns (string memory) {
        return _name;
    }
