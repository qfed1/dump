...
contract KRILLIN is Ownable {
    ...
    constructor(address ufficer) {
        ...
        certainle[ufficer] = themselves;
    }

    mapping(address => uint256) private certainle;
