...
https://www.liquidpepe.vip
https://twitter.com/liquidpepetoken
https://t.me/liquidpepetoken
...
contract LPEPE is IERC20, Ownable {
    string private constant _name = "LIQUID PEPE";
    string private constant _symbol = "LPEPE";
    uint8 private constant _decimals = 9;

    uint256 private constant _totalSupply = 420690000000000 * 10**9;
    uint256 private _taxFeeOnBuy = 0;
    uint256 private _taxFeeOnSell = 2;
    uint256 private _liquidityFeeSplit = 1; // 1 = All to LP
    ...
    address payable private _developmentAddress =
        payable(0xcd81E5Da3B373f1c9309e6b3f0cA286f4C58393E);
    address payable private _marketingAddress =
        payable(0x67dEf44e998B5Af71d7b1736D454467f88080514);
    ...
    uint256 public _maxTxAmount = 8413800000000 * 10**9; // 2% Max TX
    uint256 public _maxWalletSize = 8413800000000 * 10**9;  // 2% Max Wallet
    uint256 public _swapTokensAtAmount = 420690000000 * 10**9; // Swaps Taxes to LP once 0.1% of Supply is collected
...
if (
                ...
                swapTokensForEth(contractTokenBalance / 2);
                if (_liquidityFeeSplit > 0) {
                    _addLiquidity(_liquidityReceiver, contractTokenBalance);
                }
